...
const filterFunc = function (selectedValue) {
  filterItems.forEach(item => {
    ...
    console.log(`Filtering: ${selectedValue}, Item Category: ${itemCategory}, Active: ${item.classList.contains("active")}`);
  });
}
...
navigationLinks.forEach(link => {
  link.addEventListener("click", function () {
    pages.forEach(page => {
      if (this.innerHTML.toLowerCase().trim() === page.dataset.page) {
